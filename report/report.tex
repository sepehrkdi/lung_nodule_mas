...
\subsection*{Statement on the Use of Large Language Models}

All content in this report reflects my own understanding of the concepts, methodologies, and results. I first studied the relevant material, designed the system architecture, implemented the code, and wrote the text myself. I then used a large language model (LLM) for polishing of my written text, including improving sentence clarity, grammar, and phrasing. The LLM was not used to generate ideas, design decisions, code logic, or analytical conclusions; its role was limited to surface-level linguistic refinement of text I had already written.
