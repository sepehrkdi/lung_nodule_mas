...
Following the principles of collective intelligence~\cite{wolf2015collective}, disagreement is detected when $\sigma > 0.15$. The resolution strategies are inspired by multi-agent conflict resolution taxonomies~\cite{conflict2025resolution}, focusing on voting and arbitration. Two resolution strategies are applied in order:
